...
INSERT INTO `admin_roles` VALUES (1,'Super Admin','strapi-super-admin','Super Admins can access and manage all features and settings.','2023-08-23 18:07:42.594000','2023-08-23 18:07:42.594000',NULL,NULL),(2,'Editor','strapi-editor','Editors can manage and publish contents including those of other users.','2023-08-23 18:07:42.600000','2023-08-23 18:07:42.600000',NULL,NULL),(3,'Author','strapi-author','Authors can manage the content they have created.','2023-08-23 18:07:42.604000','2023-08-23 18:07:42.604000',NULL,NULL);
...
INSERT INTO `admin_users` VALUES (1,'flavio','mataqque',NULL,'mataqque.100@gmail.com','$2a$10$n8iQdm0uWx192Qz9Dw8J8OXUDcRBaehHVZLbFB4BTXn/TyWhS8Ppu',NULL,NULL,1,0,NULL,'2023-08-23 18:09:01.581000','2023-08-23 18:09:01.581000',NULL,NULL);
...
CREATE TABLE `files` (
  ...
  `formats` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  `provider_metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  CONSTRAINT `files_chk_1` CHECK (json_valid(`formats`)),
  CONSTRAINT `files_chk_2` CHECK (json_valid(`provider_metadata`))
...
INSERT INTO `i18n_locale` VALUES (1,'English (en)','en','2023-08-23 18:07:42.564000','2023-08-23 18:07:42.564000',NULL,NULL);
...
CREATE TABLE `sentences` (
  ...
  `spanish` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime(6) DEFAULT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  ...
  `updated_by_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sentences_created_by_id_fk` (`created_by_id`),
  KEY `sentences_updated_by_id_fk` (`updated_by_id`),
  CONSTRAINT `sentences_created_by_id_fk` FOREIGN KEY (`created_by_id`) REFERENCES `admin_users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `sentences_updated_by_id_fk` FOREIGN KEY (`updated_by_id`) REFERENCES `admin_users` (`id`) ON DELETE SET NULL
...
INSERT INTO `sentences` VALUES (23,'i wasnt so tired yesterday','No estaba tan cansado ayer','2023-08-26 13:24:50.737000','2023-08-26 13:24:50.737000',NULL,NULL,NULL),(31,'no estaba tan cansado','i wasn\'t so tired yesterday','2023-08-29 00:42:20.024000','2023-08-29 00:42:20.024000',NULL,NULL,NULL),(32,'Im happyb','Estoy feliz','2023-08-29 21:15:29.955000','2023-08-29 21:15:29.955000',NULL,NULL,NULL);
/*!40000 ALTER TABLE `sentences` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sentences_userphone_links`
--

DROP TABLE IF EXISTS `sentences_userphone_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sentences_userphone_links` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `sentence_id` int unsigned DEFAULT NULL,
  `user_id` int unsigned DEFAULT NULL,
  `sentence_order` double unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `sentences_userphone_links_unique` (`sentence_id`,`user_id`),
  KEY `sentences_userphone_links_fk` (`sentence_id`),
  KEY `sentences_userphone_links_inv_fk` (`user_id`),
  KEY `sentences_userphone_links_order_inv_fk` (`sentence_order`),
  CONSTRAINT `sentences_userphone_links_fk` FOREIGN KEY (`sentence_id`) REFERENCES `sentences` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sentences_userphone_links_inv_fk` FOREIGN KEY (`user_id`) REFERENCES `up_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sentences_userphone_links`
--

LOCK TABLES `sentences_userphone_links` WRITE;
/*!40000 ALTER TABLE `sentences_userphone_links` DISABLE KEYS */;
INSERT INTO `sentences_userphone_links` VALUES (18,31,4,1),(19,32,6,1);
/*!40000 ALTER TABLE `sentences_userphone_links` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `strapi_webhooks` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `strapi_webhooks_chk_1` CHECK (json_valid(`headers`)),
  CONSTRAINT `strapi_webhooks_chk_2` CHECK (json_valid(`events`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `up_permissions` VALUES (1,'plugin::users-permissions.user.me','2023-08-23 18:07:42.500000','2023-08-23 18:07:42.500000',NULL,NULL),(2,'plugin::users-permissions.auth.changePassword','2023-08-23 18:07:42.500000','2023-08-23 18:07:42.500000',NULL,NULL),(3,'plugin::users-permissions.auth.callback','2023-08-23 18:07:42.506000','2023-08-23 18:07:42.506000',NULL,NULL),(4,'plugin::users-permissions.auth.connect','2023-08-23 18:07:42.506000','2023-08-23 18:07:42.506000',NULL,NULL),(5,'plugin::users-permissions.auth.forgotPassword','2023-08-23 18:07:42.506000','2023-08-23 18:07:42.506000',NULL,NULL),(6,'plugin::users-permissions.auth.register','2023-08-23 18:07:42.506000','2023-08-23 18:07:42.506000',NULL,NULL),(7,'plugin::users-permissions.auth.resetPassword','2023-08-23 18:07:42.506000','2023-08-23 18:07:42.506000',NULL,NULL),(8,'plugin::users-permissions.auth.emailConfirmation','2023-08-23 18:07:42.506000','2023-08-23 18:07:42.506000',NULL,NULL),(9,'plugin::users-permissions.auth.sendEmailConfirmation','2023-08-23 18:07:42.506000','2023-08-23 18:07:42.506000',NULL,NULL),(16,'api::sentence.sentence.createSentence','2023-08-23 18:16:27.301000','2023-08-23 18:16:27.301000',NULL,NULL),(17,'api::sentence.sentence.createSentence','2023-08-23 18:16:31.879000','2023-08-23 18:16:31.879000',NULL,NULL),(18,'api::sentence.sentence.getSentences','2023-08-23 19:05:03.998000','2023-08-23 19:05:03.998000',NULL,NULL),(19,'api::sentence.sentence.getSentences','2023-08-23 19:05:09.587000','2023-08-23 19:05:09.587000',NULL,NULL),(20,'api::sentence.sentence.deleteSentence','2023-08-27 17:45:53.930000','2023-08-27 17:45:53.930000',NULL,NULL),(21,'api::sentence.sentence.deleteSentence','2023-08-27 17:45:59.415000','2023-08-27 17:45:59.415000',NULL,NULL),(22,'api::sentence.sentence.cronSentences','2023-08-28 22:53:12.053000','2023-08-28 22:53:12.053000',NULL,NULL),(23,'api::sentence.sentence.cronSentences','2023-08-28 22:53:17.710000','2023-08-28 22:53:17.710000',NULL,NULL);
...
INSERT INTO `up_permissions_role_links` VALUES (1,1,1,1),(2,2,1,1),(3,3,2,1),(4,4,2,1),(5,5,2,1),(6,8,2,2),(7,7,2,2),(8,9,2,2),(9,6,2,2),(16,16,2,3),(17,17,1,2),(18,18,2,4),(19,19,1,3),(20,20,2,5),(21,21,1,4),(22,22,2,6),(23,23,1,5);
...
INSERT INTO `up_roles` VALUES (1,'Authenticated','Default role given to authenticated user.','authenticated','2023-08-23 18:07:42.492000','2023-08-28 22:53:17.707000',NULL,NULL),(2,'Public','Default role given to unauthenticated user.','public','2023-08-23 18:07:42.495000','2023-08-28 22:53:12.048000',NULL,NULL);
...
CREATE TABLE `up_users` (
  ...
  `created_by_id` int unsigned DEFAULT NULL,
  `updated_by_id` int unsigned DEFAULT NULL,
  `cel` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `up_users` VALUES (4,'mataqque.100@gmail.com','mataqque.100@gmail.com',NULL,NULL,NULL,NULL,0,0,'2023-08-26 13:26:12.011000','2023-08-30 02:03:19.590000',NULL,1,'51946008051','0 */3 * * * *'),(6,NULL,NULL,NULL,NULL,NULL,NULL,0,0,'2023-08-29 21:15:29.941000','2023-08-29 21:18:21.444000',NULL,NULL,'51918779815','0 */3 * * * *');
...
-- Dump completed on 2024-06-09 23:33:29
